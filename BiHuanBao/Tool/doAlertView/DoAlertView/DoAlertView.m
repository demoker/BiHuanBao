...
- (void)showAlertView
{
    ...
    _vAlert.backgroundColor = [UIColor redColor];//DO_RGBA(255, 255, 255, 0.9);
    ...
    if (_bDestructive)
        vBody.backgroundColor = [UIColor whiteColor];//DO_DESTRUCTIVE_BOX;
    else
...
//ff602a
        btYes.backgroundColor = DO_RGB(255, 80, 0);//DO_BUTTON_BOX;
