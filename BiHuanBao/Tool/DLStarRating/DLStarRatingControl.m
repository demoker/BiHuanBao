...
- (void)setupView {
	...
	for (int i=0; i<numberOfStars; i++) {
		DLStarView *v = [[DLStarView alloc] initWithDefault:self.star highlighted:self.highlightedStar position:i allowFractions:isFractionalRatingEnabled withsuperView:self];
		[self addSubview:v];
	}
}
