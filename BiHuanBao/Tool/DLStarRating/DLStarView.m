...
- (id)initWithDefault:(UIImage*)star highlighted:(UIImage*)highlightedStar position:(int)index allowFractions:(BOOL)fractions withsuperView:(UIView *)view {
	...
	if (self) {
        ...
        float width = view.frame.size.width/kDefaultNumberOfStars;
        self.frame = CGRectMake(width*index, 0, view.frame.size.height, view.frame.size.height);
...
//    [self setImage:highlightedImage forState:UIControlStateHighlighted];
    [self setBackgroundImage:starImage forState:UIControlStateNormal];
