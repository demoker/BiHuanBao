...
- (void)setStatus:(NSString *)string {
    ...
    if(string) {
        ...
        if(hudHeight > 60) {
            labelRect = CGRectMake(12, 55, hudWidth, stringHeight);
            hudWidth+=24;
        } else {
            hudWidth+=24;  
            labelRect = CGRectMake(0, 55, hudWidth, stringHeight);
        }
    }
	...
	if(string)
		self.spinnerView.center = CGPointMake(ceil(CGRectGetWidth(self.hudView.bounds)/2)+0.5, 30.5);
	else
...
- (CGFloat)visibleKeyboardHeight {
    ...
    if(foundKeyboard && foundKeyboard.bounds.size.height > 80)
