...
#import "JCTopic.h"
@interface BiHuanBaoRootController : BaseViewController<UITableViewDataSource,UITableViewDelegate,TableViewDelegate,JCTopicDelegate>
{
